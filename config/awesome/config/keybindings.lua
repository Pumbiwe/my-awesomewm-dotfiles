...
local hotkeys = gears.table.join(
    awful.key({ }, "Print", function()
        ...
        naughty.notify({title="Scrot", text="Screenshot successfully taken in Pictures folder!", timeout=2})
    end),
    ...
    awful.key({ modkey },            "r",     function () awful.spawn("rofi -show drun -theme rounded-nord-dark") end,
