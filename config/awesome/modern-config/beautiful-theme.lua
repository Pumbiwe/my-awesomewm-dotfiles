...
local colors = require("modern-config.colors")
...
theme.font_var      = "Roboto Medium"
theme.icon_var      = "Material Icons Round "
theme.icon_alt_var  = "Material Icons Outlined "
theme.title_pos     = "top"
theme.bar_size      = dpi(54)
theme.rounded       = dpi(15)
theme.rounded_wids  = dpi(13)
theme.font = "Roboto Medium " .. dpi(12)
...
theme.useless_gap           = dpi(10) or 7
theme.border_width          = dpi(1)
border_shape		    = helpers.rrect(theme.rounded)
theme.border_color_normal   = theme.accent
theme.border_color_active   = theme.accent

theme.notification_font             = "Roboto Medium" .. dpi(12)
...
otification_border_color            = theme.accent
...
theme.awesome_icon = require("gears.filesystem").get_configuration_dir() .. "modern-config/assets/arch.png"
theme.sound_icon = require("gears.filesystem").get_configuration_dir() .. "modern-config/assets/volume.png"
